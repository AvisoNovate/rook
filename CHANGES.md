...
* Failure messages are now more uniform, and generated by new function io.aviso.rook.utils/failure-response.
* When using wrap-with-timeout, there is no a :timeout-control-ch key added to the request, allowing
